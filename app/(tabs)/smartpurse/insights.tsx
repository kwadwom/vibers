    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.tabs}>
          <Link href="/(tabs)/smartpurse/transactions" asChild>
            <TouchableOpacity>
              <Text style={styles.tab}>Transactions</Text>
            </TouchableOpacity>
          </Link>
          <Link href="/(tabs)/smartpurse/budget" asChild>
            <TouchableOpacity>
              <Text style={styles.tab}>Budgets</Text>
            </TouchableOpacity>
          </Link>
          <Link href="/(tabs)/smartpurse/goals" asChild>
            <TouchableOpacity>
              <Text style={styles.tab}>SavingGoals</Text>
            </TouchableOpacity>
          </Link>
          <Link href="/(tabs)/smartpurse/insights" asChild>
            <TouchableOpacity>
